...
"><strong> Information Order :</strong></div>
       ...
       <div class="col-md-3 text-left" id="noorder"><strong>No Order        :</strong></div><div class="col-md-2 text-left">
          <strong>
            <?=str_replace('OCLB', '', $orderdis->no_order) ?>    
          </strong>
        </div>
       <div class="row"></div>
        <div class="row"></div>
  ...
  <div class="col-md-6 col-md-offset-3">
    ...
    <form action="" method="" enctype="multipart/form-data" id="form-confirm" >
      ...
      <div class="form-group row">
        ...
        <div class="col-xs-5">
          <input class="form-control" name="no_order" id="no_order" type="hidden"  placeholder="No Order" value="<?=str_replace('OCLB', '', $orderdis->no_order) ?>" >
        </div>
      </div>
      <div class="form-group row">
...
<?php if(env('APP_PROJECT')=='Celebgramme') {
  echo 'Silahkan hubungi kami di line @Celebpost atau email activpost@gmail.com';
} else {
  echo 'Silahkan hubungi kami di email support@amelia.id';
}?>
