            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <form action="{{ url('search-orders') }}" method="GET" class="navbar-form" role="search">
											...
											<label class="radio-inline"><input type="radio" name="q2" value="all" <?= ("All" == $pes) ? 'checked' : '';?>> All</label>
											<label class="radio-inline"><input type="radio" name="q2" value="Confirmed" <?=  ("Confirmed" == $pes) ? 'checked' : '';?>>Confirmed</label>
											<label class="radio-inline"><input type="radio" name="q2" value="Not Confirmed" <?= ("Not Confirmed" == $pes) ? 'checked' : '';?>>Not Confirmed
