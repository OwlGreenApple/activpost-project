...
<div class="container">
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <a href="{{ url('show-addadmin') }}" data-toggle="modal" id="button-add" class="btn btn-info ls-modal4" style="margin-top: 25px;" >Add Admin</a>
                    ...
                    <form action="{{ url('search-admin') }}" method="GET" class="navbar-form" role="search">
    ...
    <tr>
        ...
        <td>{{$usersn->email}}</td>
        <td>
          <button class="btn btn-info btn-show-log" data-toggle="modal" data-target="#myModal" data-id="{{$usersn->id}}">
            View Log
          </button>
        </td>
...
$("body").on('click','#btn-search-log', function(e){
  get_log();
});
...
$(document).ready(function(){
  ...
  $("#from_log").datepicker('setDate', new Date());
  $("#to_log").datepicker('setDate', new Date());
});
    </script>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="formlog" style="margin-bottom: 20px">
          ...
          <div class="form-group form-group-sm row">
            ...
            <div class="col-sm-8 col-md-3">
              <input type="text" class="form-control formatted-date" name="from_log" id="from_log">
            </div>
            <div class="col-sm-1 col-md-1">s/d</div>
            <div class="col-sm-8 col-md-3">
              <input type="text" class="form-control formatted-date" name="to_log" id="to_log">
            </div>
          </div> 
