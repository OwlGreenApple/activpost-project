            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <div class="pull-right">
                        <a href="{{ url('schedule-video') }}" class="btn btn-sm btn-danger">Back</a>
                    </div>
                </div>
                <div class="panel-body">
                    ...
                    <form name="uploader" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="file" name="file[]" id="LfileInput" >
                            </div>
                            <div class="form-group col-md-6">
                    ...
                    <!--</form>
                    <form role="form">-->
                        <input type="hidden" name="imguri" value="{{ url('schedule-video/save') }}">
                        <input type="hidden" name="saveuri" value="{{ url('schedule-video/publish') }}">
                        <input type="hidden" name="ruri" value="{{ url('schedule-video') }}">
                        <input type="hidden" name="id" value="{{ $schedule->id }}">
